...
public class BeerClientMockTest {
    ...
    void testListBeersWithQueryParam() throws JsonProcessingException {
        String respone = objectMapper.writeValueAsString(getPage());
        ...
        server.expect(method(HttpMethod.GET))
                ...
                .andRespond(withSuccess(respone, MediaType.APPLICATION_JSON));
    ...
    void testDeleteBeer() {
        ...
        // server will verify to receive that request
        server.verify();
    }
    ...
    void testListBeers() throws JsonProcessingException {
        ...
        Page<BeerDTO> dtos = beerClient.listBeers(null);
